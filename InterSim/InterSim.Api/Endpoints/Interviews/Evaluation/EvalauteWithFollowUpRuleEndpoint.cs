...
public static class EvaluateWithFollowUpRuleEndpoint
{
    public static void MapEvaluateWithFollowUpRule(this IEndpointRouteBuilder app)
    {
        app.MapPost("/interviews/evaluate-with-followup-rule",
            async (
                EvaluateWithFollowUpRuleRequest req,
