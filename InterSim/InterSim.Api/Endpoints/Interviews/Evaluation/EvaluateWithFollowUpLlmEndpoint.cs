...
public static class EvaluateWithFollowUpLlmEndpoint
{
    public static void MapEvaluateWithFollowUpLlm(this IEndpointRouteBuilder app)
    {
        app.MapPost("/interviews/evaluate-with-followup-llm",
            async (
                EvaluateWithFollowUpLlmRequest req,
                BehavioralEvaluatorV2 evaluator,
                ILlmFollowUpTrigger llmTrigger,
                ...
                CancellationToken ct) =>
            {
                ...
                var decision = await llmTrigger.DecideAsync(
                    req.QuestionText,
                    req.AnswerText,
                    preview.TotalScore,
